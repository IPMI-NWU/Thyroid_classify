...
class CNNEncoder():
    def __init__(self):
        ...
        self.dense_net = nn.Sequential(*modules)
        self.dense_net.eval()
        self.dense_net.cuda()
...
class RNNEncoder():
    def __init__(self):
        ...
        net.load_state_dict(
            torch.load("/media/wu24/wu24/wu24/Thyroid/unsupervised/Thyroid/model/densenet169_ce/epoch49.pth")['net'])
...
if __name__ == '__main__':
    ...
    des_png_dir='/media/wu24/wu24/wu24/Thyroid/unsupervised/data/c1'
    ...
    for kfb_name in kfb_names:
            ...
            for x in range(x_nums):
                for y in range(y_nums):
                    ...
                    if is_valid_patch(tile):
                        xs.append(x)
                        ys.append(y)
                        cnn_feature=cnn_encoder.get_feature(tile)
            ...
            width, height = slide.level_dimensions[6]
