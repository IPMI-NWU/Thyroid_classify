...
from Thyroid.Rnn_attention_embeding_large import Encoder
...
class CNNEncoder():
    def __init__(self):
        res_net = models.inception_v3(pretrained=True)
...
class RNNEncoder():
    def __init__(self):
        ...
        net.load_state_dict(
            torch.load("/media/administrator/wu24/wu24/ThyroidData/slide_classification/Thyroid/model/DANet.pth")['net'])
...
if __name__ == '__main__':
    src_kfb_dir = '/media/administrator/wu24/wu24/ThyroidData/Training347'
    ...
    for kfb_name in kfb_names:
        if kfb_name == '1210100.kfb':
            ...
            print(zoom.level_dimensions[zoom_level])
            ...
            img = slide.read_region((0, 0), slide_level, (width, height))
            img = cv2.resize(img, (x_nums, y_nums))
